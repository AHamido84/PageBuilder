...
export const formsBlocks: BlockDefinition<any>[] = [
  {
    ...
    defaultData: {
      en: { heading: "Get in touch", body: "Tell us what your business needs.", submitLabel: "Send message", showMessage: true },
      ar: { heading: "تواصل معنا", body: "أخبرنا بما تحتاجه شركتك.", submitLabel: "إرسال الرسالة", showMessage: true },
    },
  ...
  } as BlockDefinition<LeadFormData>,
  {
    ...
    dataSchema: leadFormSchema,
    defaultData: {
      en: { heading: "Request a quote", body: "Send us your product categories and order volumes.", submitLabel: "Request a quote", showMessage: true },
      ar: { heading: "اطلب عرض سعر", body: "أرسل لنا فئات المنتجات وأحجام الطلب.", submitLabel: "طلب عرض سعر", showMessage: true },
    },
    defaultSettings: defaultSectionSettings({ background: "frost" }),
    Edit: LeadFormEdit,
    Render: LeadFormRender,
